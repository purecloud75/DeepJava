...
문자열의 결합이나 변경이 잦다면, 내용을 변경가능한 StringBuffer 혹은 StringBuilder 클래스를 쓰자. 새로운 객체 안만들고도 문자열 조작가능!
이 친구들은 내부 버퍼(데이터를 임시로 저장하는 메모리)에 문자열을 저장해 두고, 그 안에서 추가 수정 삭제 작업을 할 수 있도록 설계되어있다.
 */
